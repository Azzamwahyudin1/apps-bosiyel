  ...
  return (
    <footer className="w-full bg-[#050915] border-t border-white/10 py-8 px-4 text-center mt-12">
      <motion.div 
        ...
        className="max-w-md md:max-w-2xl lg:max-w-5xl mx-auto flex flex-col items-center gap-4"
      >
        <img src={logoImg} alt="BOS IYEL Logo" className="w-16 h-16 rounded-full border border-cyan-400" />
        <h3 className="font-protest text-xl tracking-wider text-cyan-400">BOS IYEL</h3>
